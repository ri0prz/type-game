...
<body class="d-flex flex-column justify-content-center align-items-center" style="height: 100vh;">
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center">
        ...
        <form action="" method="post" class="d-flex flex-column justify-content-center align-items-center">
            ...
            <input type="text" name="username" id="username" autocomplete="off" require><br>

            <label for="password">Password.</label>
            <input type="password" name="password" id="password" autocomplete="off" require><br>

            <label for="password">Re-type Password.</label>
            <input type="password" name="password2" id="password2" autocomplete="off"require>
